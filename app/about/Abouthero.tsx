...
const Abouthero = () => {
	return (
		<div>
			<main className="w-full h-[600px] md:h-[700px]  bg-cover bg-no-repeat bg-hero relative">
				<div className="absolute top-0 left-0 w-full h-full  bg-gradient-to-br  from-violet-950 via-[#361472d9] to-transparent flex flex-col justify-center">
					<div className="container px-4 text-wrap mx-auto text-white md:max-w-[700px] lg:max-w-[900px] xl:max-w-[1200px] 2xl:max-w-[1300px]">
						<h6 className="md:text-[25px] font-semibold text-left tracking-widest flex items-center">
							<div className="md:w-[60px] w-[60px] mr-4 h-[1px] bg-white" />
							ABOUT TOP-KEM
						</h6>
						<div className="mt-4 text-[35px] md:text-[60px]">
							<h1 className="font-bold md:leading-[79px] leading-9">
								Caring about your <br /> cleaning needs
							</h1>
						</div>
						<div className="flex mt-10">
							<div className="flex-1">
								<p className="md:text-[20px] text-[14px] w-[100%] text-white/70 md:leading-[39px] text-left font-normal ">
									We are a professional cleaning company founded in
									2020 and providing leading commercial and
									residential cleaning solutions in the United States.
								</p>
							</div>
